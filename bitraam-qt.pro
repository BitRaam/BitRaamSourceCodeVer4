...
#LIBS += -lboost_system-mgw48-mt-s-1_55 -lboost_filesystem-
...
contains(BITRAAM_NEED_QT_PLUGINS, 1) {
    DEFINES += BITRAAM_NEED_QT_PLUGINS
...
HEADERS += src/qt/bitraamgui.h \
    ...
    src/qt/bitraamaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/bitraam.cpp \
    src/qt/bitraamgui.cpp \
    ...
    src/qt/bitraamaddressvalidator.cpp \
    src/alert.cpp \
    src/chainparams.cpp \
    src/version.cpp \
    src/sync.cpp \
...
contains(BITRAAM_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = BitRaam-qt_test
DEFINES += BITRAAM_QT_TEST
...
# also add new translations to src/qt/bitraam.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/bitraam_*.ts)
...
win32:DEFINES += WIN32
win32:RC_FILE = src/qt/res/bitraam-qt.rc
...
macx:ICON = src/qt/res/icons/bitraam.icns
